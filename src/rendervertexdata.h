...
enum class Buffer_Type { VERTEX, INDEX, NONE };
enum class Buffer_Usage_Type { DYNAMIC_DRAW, STATIC, NONE };
...
public:
  ...
  void vboCreate(std::string name, Buffer_Type type, Buffer_Usage_Type usage);
